...
<section id="tools">
  ...
  <div class="use"><h4>Reviewing a run</h4><ol>
    ...
    <li>If areas look wrong by a constant factor, 📏 Calibrate / re-anchor… — verify the automatic disc fit (measure by hand only if the fit refuses). On a saved run this re-anchors: every mm² is re-derived from the stored px.</li>
